...
type "%ROOT%\src\cmacchiato\colorv\interactions.css" "%ROOT%\src\cmacchiato\colorv\other.css" "%ROOT%\src\cmacchiato\colorv\text.css" "%ROOT%\src\cmacchiato\pixelv\fonts.css" "%ROOT%\src\cmacchiato\pixelv\margins.css" "%ROOT%\src\cmacchiato\trans.css" "%ROOT%\src\cmacchiato\api.css"> "%ROOT%\build\dist\cmacchiato\pixelv\style.css"
