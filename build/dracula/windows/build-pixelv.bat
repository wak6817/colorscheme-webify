...
type "%ROOT%\src\dracula\colorv\interactions.css" "%ROOT%\src\dracula\colorv\other.css" "%ROOT%\src\dracula\colorv\text.css" "%ROOT%\src\dracula\pixelv\fonts.css" "%ROOT%\src\dracula\pixelv\margins.css" "%ROOT%\src\dracula\trans.css" > "%ROOT%\build\dist\dracula\pixelv\style.css"
